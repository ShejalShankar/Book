													...
													<td width="50%" height="100%">
														<table border="0"  width="100%" height="100%">
															...
															<tr>
																...
																<td>: </td>
																<td align="left"><font color = "blue"><b>Rs:'.$row['b_price'].'</b></font></td>
															</tr>

															<tr>
																<td align="right"><b><font color = "black"> Book</font></td>
																<td>: </td></b>
												 ...
												 if(isset($_SESSION['status']))
												 {
												 	if($row['b_qty']>=1){
														...
														<img src="images/addcart.jpg">
																	...
																	echo '<center><h2><font color ="white">Out of Stock</font></h2>
																		<a href="category.php">See Other Books</a></center>';
																}
													
												} 
												else
												{
													echo '<td><img src="images/addcart.jpg"><br><a href="login.php"> <h4>Please Login..</h4></a></td>';
												}
												echo '</tr>
											</table>';
										?>
