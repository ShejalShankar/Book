...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 25, 2017 at 11:17 AM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `date`(OUT `pdate` DATE)
    NO SQL
BEGIN
	DECLARE p_inter Date;
	SET p_inter = DATE_FORMAT(CURDATE()+INTERVAL 2 DAY,'%Y-%m-%d %hh:%mm:%ss');
	SET pdate = p_inter;
	SELECT pdate;
	
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `date1`(OUT `pdate` DATE)
    NO SQL
BEGIN
	DECLARE p_inter Date;
	SET p_inter = DATE_FORMAT(CURDATE()+INTERVAL 3 DAY,'%Y-%m-%d');
	SET pdate = p_inter;
	SELECT pdate;
...
(49, 'PAKISTAN`S DRIFT INTO EXTREMISM', '13', 'The book studies the rise of religious extremism in pakistan and analyses its connection to the pakistani army policies and fluctuating US - Pakistani Relationship. It is a book which readers as well as students of Political Science and history will enjoy thoroughly.', 'Hassan Abbas ', '2001', '8182741580', 350, 600, 'upload_image/terr2.jpg', 19),
(50, 'Learning SQL on SQL Server 2005 : The Simplest Way', '18', 'Anyone who interacts with today?s modern databases needs to know SQL (Structured Query Language), the standard language for generating, manipulating, and retrieving database information. In recent years, the dramatic rise in the popularity of relational databases and multiuser databases has fueled a healthy demand for application devel?opers and others who can write SQL code efficiently and correctly. If you?re new to databases or need a SQL refresher, Learning SQL on SQL Server 2005 is an ideal step-by-step introduction to this database query tool, with everything you need for programming SQL using Microsoft?s SQL Server 2005?one of the most powerful and popular database engines used today. Plenty of books explain database theory. This guide lets you apply the theory as you learn SQL. You don?t need prior database knowledge, or even prior computer knowledge. Based on a popular university-level course designed by authors Sikha Saha Bagui and Richard Walsh Earp, Learning SQL on SQL Server 2005 starts with very simple SQL concepts, and slowly builds into more complex query development. Every topic, concept, and idea comes with examples of code and output, along with exercises to help you gain proficiency in SQL and SQL Server 2005. With this book, you?ll learn: * Beginning SQL commands, such as how and where to type an SQL query, and how to create, populate, alter, and delete tables * How to customize SQL Server 2005?s settings and about SQL Server 2005?s functions * About joins, a common database mechanism for combining tables * Query development, the use of views and other derived structures, and simple set operations * Subqueries, aggregate functions, and correlated subqueries, as well as indexes and constraints that can be added to tables in SQL Server 2005 Whether you?re a self-learner who has access to the new Microsoft database, working on SQL Server with access at your company, or a computer science student or MIS student, Learning SQL on SQL Server 2005 will get you up to speed on SQL in no time.\r\n\r\n', 'Sikha Saha Bagui, Richard Walsh Earp ', '2005', '9788184040', 360, 350, 'upload_image/comp10.jpg', 10),
(51, 'Engineering Mathematics-1', '37', 'maths', 'Sudha', 'Fourth', '123455', 400, 100, 'upload_image/m1.jpg', 0),
(52, 'Journal of Business Ethics', '38', 'The Journal of Business Ethics is a peer-reviewed academic journal published by Springer Science+Business Media covering methodological and disciplinary aspects of ethical issues related to business', 'Springer Science+Business Media', 'Fourth', '123455', 25099, 1000, 'upload_image/jbe.jpg', 2),
(53, 'Harvard Business Review', '41', 'The Harvard Business Review is a general management magazine published by Harvard Business Publishing, a wholly owned subsidiary of Harvard University. HBR is published 6 times a year and is headquartered in Brighton Watertown, Massachusetts.', 'Joshua Macht', 'twelvth', '32466', 100, 200, 'upload_image/1200x630bb.jpg', 2),
(54, 'Bioresource Technology', '40', 'Bioresource Technology is a peer-reviewed scientific journal published biweekly by Elsevier, covering the field of bioresource technology. According to the Journal Citation Reports, it has a 2014 impact factor of 4.494', 'Elsevier', 'seventh', '246788', 146, 500, 'upload_image/Bioresource-Technology.jpg', 3);
...
INSERT INTO `contact` (`con_id`, `con_nm`, `con_email`, `con_query`, `c_name`) VALUES
...
(6, 'Gowtham Bhatta', 'dvd@sds', 'scscsv', 'GBK1');
...
INSERT INTO `shipping_details` (`id`, `Fnam`, `lname`, `address`, `postal_code`, `city`, `state`, `phone`, `u_name`, `t_price`) VALUES
(3, 'mani', 'kanta', 'BANGALORE', 560004, 'Bangalore', 'Karnataka', 8105073753, '1234', 0),
(4, 'mani', 'kanta', 'BANGALORE', 560004, 'Bangalore', 'Karnataka', 8105073753, '1234', 0),
(14, 'mani', 'kanta', 'BANGALORE', 560004, 'Bangalore', 'Karnataka', 8105073753, '1234', 0),
(15, 'mani', 'kanta', 'BANGALORE', 560004, 'Bangalore', 'Karnataka', 8105073753, '1234', 0),
(16, 'mani', 'kanta', 'BANGALORE', 560004, 'Bangalore', 'Karnataka', 8105073753, '1234', 0),
(17, 'mani', 'kanta', '#83, Sri Durga Sweets and Condiments Stores,\r\nThavarekere Main Road,DRC Post,Thavarekere', 560004, 'Bangalore', 'Karnataka', 8105073753, '1234', 0),
(19, 'mani', 'kanta', '#83, Sri Durga Sweets and Condiments Stores,\r\nThavarekere Main Road,DRC Post,Thavarekere', 560004, 'Bangalore', 'Karnataka', 8105073753, '1234', 2659),
(20, 'mani', 'kanta', '#83, Sri Durga Sweets and Condiments Stores,\r\nThavarekere Main Road,DRC Post,Thavarekere', 560004, 'Bangalore', 'Karnataka', 8105073753, '1234', 2659),
(21, 'mani', 'kanta', '#83, Sri Durga Sweets and Condiments Stores,\r\nThavarekere Main Road,DRC Post,Thavarekere', 560004, 'Bangalore', 'Karnataka', 8105073753, '1234', 2659),
(22, 'mani', 'kanta', '#83, Sri Durga Sweets and Condiments Stores,\r\nThavarekere Main Road,DRC Post,Thavarekere', 560004, 'Bangalore', 'Karnataka', 8105073753, '1234', 4636),
(23, 'mani', 'kanta', '#83, Sri Durga Sweets and Condiments Stores,\r\nThavarekere Main Road,DRC Post,Thavarekere', 560004, 'Bangalore', 'Karnataka', 8105073753, '1234', 372),
(24, 'mani', 'kanta', '#83, Sri Durga Sweets and Condiments Stores,\r\nThavarekere Main Road,DRC Post,Thavarekere', 560004, 'Bangalore', 'Karnataka', 8105073753, '1234', 372),
(25, 'mani', 'kanta', '#83, Sri Durga Sweets and Condiments Stores,\r\nThavarekere Main Road,DRC Post,Thavarekere', 560004, 'Bangalore', 'Karnataka', 8105073753, '1234', 3720),
(26, 'mani', 'kanta', '#83, Sri Durga Sweets and Condiments Stores,\r\nThavarekere Main Road,DRC Post,Thavarekere', 560004, 'Bangalore', 'Karnataka', 8105073753, '1234', 6545),
(27, 'mani', 'kanta', 'BANGALORE', 560004, 'Bangalore', 'Karnataka', 8105073753, '1234', 6645),
(28, 'mani', 'kanta', '#83, Sri Durga Sweets and Condiments Stores,\r\nThavarekere Main Road,DRC Post,Thavarekere', 560004, 'Bangalore', 'Karnataka', 8105073753, '', 0),
(29, 'mani', 'kanta', '#83, Sri Durga Sweets and Condiments Stores,\r\nThavarekere Main Road,DRC Post,Thavarekere', 560004, 'Bangalore', 'Karnataka', 8105073753, '1234', 2636),
(30, 'Gowtham', 'Bhatta', 'BANGALORE', 560004, 'Bangalore', 'Karnataka', 8105073753, '1234', 1185),
(31, 'Gowtham', 'Bhatta', 'BANGALORE', 560004, 'Bangalore', 'Karnataka', 8105073753, '1234', 1818),
(32, 'mani', 'kanta', 'BANGALORE', 560004, 'Bangalore', 'Karnataka', 8105073753, '1234', 659),
(33, 'Gowtham', 'Bhatta', 'BANGALORE', 560004, 'Bangalore', 'Karnataka', 8105073753, '1234', 80),
(34, 'mani', 'kanta', 'BANGALORE', 560004, 'Bangalore', 'Karnataka', 8105073753, '4563', 372),
(36, 'mani', 'kanta', 'BANGALORE', 560004, 'Bangalore', 'Karnataka', 8105073753, 'GBK1', 1235);
...
(35, 21, 'test1'),
(37, 27, 'Maths'),
(38, 29, 'Journal of Business Ethics'),
(41, 29, 'Harvard Business Review'),
(40, 29, ' Bioresource Technology');
...
INSERT INTO `user` (`u_id`, `u_fnm`, `lnm`, `u_unm`, `u_pwd`, `u_gender`, `u_email`, `u_contact`, `u_city`) VALUES
(4, 'admin', 'joker', 'admin', 'admin123', 'male', 'admin@gmail.com', '9482303950', 'Bangalore'),
(28, 'mani', 'Bhatta', 'mani', '1234', 'Male', 'gowthambhatta@gmail.com', '8105073753', 'Bengaluru'),
(29, 'mani', 'kanta', 'GBK', '1234', 'Male', 'gowthambhatta@gmail.com', '8105073753', 'Bengaluru'),
(30, 'mani', 'kanta', 'GBK', '1234', 'Male', 'gowthambhatta@gmail.com', '8105073753', 'Bengaluru'),
(31, 'mani', 'kanta', 'GBK', '1234', 'Male', 'gowthambhatta@gmail.com', '8105073753', 'Bengaluru'),
(32, 'Sumangala', 'M', 'sumangala', '1234', 'Female', 'sumangala@gmail.com', '9481812737', 'Dakhin Kannada'),
(33, 'Chethan', 'H N', 'Cheths', '1234', 'Male', 'chethan@gmail.com', '8961548471', 'Hasan'),
(34, 'mani', 'kanta', 'mani', '1234', 'Male', 'vhmanikanta@gmail.com', '1234567891', 'Bengaluru'),
(35, 'Gowtham', 'Bhatta', 'Gowtham', '1234', 'Male', 'gowthambhatta@gmail.com', '9482303950', 'Dakhin Kannada'),
(36, 'mani', 'kanta', 'GBK1', '4563', 'Male', 'gowthambhatta@gmail.com', '8105073753', 'Bengaluru');

--
-- Triggers `user`
--
DELIMITER $$
CREATE TRIGGER `user_trig` BEFORE INSERT ON `user`
...
--
ALTER TABLE `subcat`
  MODIFY `subcat_id` int(4) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=42;
--
-- AUTO_INCREMENT for table `user`
--
ALTER TABLE `user`
  MODIFY `u_id` int(4) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=37;
